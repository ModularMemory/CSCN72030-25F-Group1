...
public partial class App : Application
{
    ...
    private static void AddDevices(ServiceProvider serviceProvider)
    {
        ...
        [
            ...
            new LightController(new DeviceId("Light-6", "South Hall"), (Watt)120),
            ...
            new FanController(new DeviceId("Fan-3", "West Hall"), (Watt)75, 1_600),
            ...
            new DoorController(new DeviceId("Door-6", "South Hall")),
