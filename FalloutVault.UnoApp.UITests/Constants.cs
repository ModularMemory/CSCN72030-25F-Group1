namespace FalloutVault.UnoApp.UITests;

public class Constants
{
    public readonly static string WebAssemblyDefaultUri = "http://localhost:5000/";
    public readonly static string iOSAppName = "com.companyname.FalloutVault.UnoApp";
    public readonly static string AndroidAppName = "com.companyname.FalloutVault.UnoApp";
